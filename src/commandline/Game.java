...

{
	...
	public String getCate(){
		String cate=activePlayer.getTopCard().getCategories().get(currentCategory).toUpperCase();
		return cate;
	}
	
	public String getAllCate(){
		
		String allcate=activePlayer.getTopCard().getCategories().toString();
		return allcate;
	} 
	...
	{
		return newRound.getCommunalPileSize();
	}
}
